...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(howMany) =>
      "${Intl.plural(howMany, one: 'An update to your playlist is being made in Spotify. We\'ll let you know when it\'s finished. Do not launch any new update until then.', other: 'An update to your playlists is being made in Spotify. We\'ll let you know when it\'s finished. Do not launch any new update until then.')}";
