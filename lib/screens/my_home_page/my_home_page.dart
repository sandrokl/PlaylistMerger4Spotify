            ...
            onPressed: () async {
              await Workmanager().registerOneOffTask(
                ...
                inputData: {
                  ...
                  "notificationInProgressChannelName": S
                      .of(context)
        ...
        child: RefreshIndicator(
          ...
          child: Center(
            child: Column(
              ...
              children: <Widget>[
                const Padding(padding: EdgeInsets.all(8.0), child: UserInfo()),
                                                            ...
                                                            onTap: () async {
                                                              await Workmanager().registerOneOffTask(
                                                                DateTime.now().millisecond
                                                                    .toString(),
                                                                WorkManagerHelper
                                                                    .TASK_DO_MERGING_NOW_SPECIFIC,
                                                                inputData: {
                                                                  "playlistId": p.playlistId,
                                                                  "notificationChannelId":
                                                                      NotificationsHelper
                                                                          .CHANNEL_KEY_MERGING_RESULTS,
                                                                  "notificationChannelName": S
                                                                      .of(context)
                                                                      .channelNameMergingResults,
                                                                  "successTitle": S
                                                                      .of(context)
                                                                  ...
                                                                  "failureMessage": S
                                                                      .of(context)
                                                                      .notificationMergingFailed,
                                                                  "notificationInProgressChannelId":
                                                                      NotificationsHelper
                                                                          .CHANNEL_KEY_IN_PROGRESS,
                                                                  "notificationInProgressChannelName": S
                                                                      .of(context)
                                                                      .notificationInProgressChannelName,
                                                                  "notificationInProgressMessage": S
                                                                      .of(context)
